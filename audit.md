...
Root dependency file for metadata generation.
...
Crash risks:
- KeyError if AU missing
- KeyError if DB missing
- KeyError if JI missing
- IndexError if dataframe empty

WoS-specific logic:
- Assumes WoS citation formatting in CR
- Assumes WoS affiliation structure in C1/RP
- Uses WoS journal fields JI/SO
