...
def get_average_citations(df):
    ...
    # but this line requires arithmetic subtraction which needs integers.
    # Fixed by converting PY to numeric before the calculation.
    table["PY"] = pd.to_numeric(table["PY"], errors="coerce")
